package com.elioo.healthcare.aws.bedrock.health.api;
 ...
 * <p>The default implementation ({@code BedrockHealthServiceImpl}) uses AWS Bedrock
...
public interface BedrockHealthService {
     ...
     * @throws com.elioo.healthcare.aws.bedrock.health.exception.BedrockHealthServiceException if generation fails
     */
     ...
     * @throws com.elioo.healthcare.aws.bedrock.health.exception.BedrockHealthServiceException if assessment fails
     */
     ...
     * @throws com.elioo.healthcare.aws.bedrock.health.exception.BedrockHealthServiceException if analysis fails
     */
     ...
     * @throws com.elioo.healthcare.aws.bedrock.health.exception.BedrockHealthServiceException if execution or parsing fails
     */
