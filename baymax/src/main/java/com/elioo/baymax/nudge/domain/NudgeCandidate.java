 ...
 * ground it.
 */
public record NudgeCandidate(NudgeRule rule, UUID familyId, UUID patientId, String triggerKey, NudgeUrgency urgency,
                             Map<String, String> vars, Set<String> numbers, List<String> cropKeys) {
}
