package com.elioo.healthcare.core.base.application.port.out.persistence;
...
public interface BasePersistencePort<T extends BaseDomain> {
    ...
    Flux<T> createList(List<T> domainObjects);
